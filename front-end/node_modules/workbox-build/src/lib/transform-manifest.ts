...
import {
  ...
  ManifestEntry,
  ManifestTransform,
} from 'workbox-build/src/types';
import {additionalManifestEntriesTransform} from 'workbox-build/src/lib/additional-manifest-entries-transform';
import {errors} from 'workbox-build/src/lib/errors';
import {maximumSizeTransform} from 'workbox-build/src/lib/maximum-size-transform';
import {modifyURLPrefixTransform} from 'workbox-build/src/lib/modify-url-prefix-transform';
import {noRevisionForURLsMatchingTransform} from 'workbox-build/src/lib/no-revision-for-urls-matching-transform';
