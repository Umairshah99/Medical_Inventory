...
import {getFileSize} from 'workbox-build/src/lib/get-file-size';
import {getFileHash} from 'workbox-build/src/lib/get-file-hash';

import {GlobPartial} from 'workbox-build/src/types';
