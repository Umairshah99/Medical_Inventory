...
import {BuildResult, InjectManifestOptions} from 'workbox-build/src/types';
import {errors} from 'workbox-build/src/lib/errors';
import {escapeRegExp} from 'workbox-build/src/lib/escape-regexp';
import {getFileManifestEntries} from 'workbox-build/src/lib/get-file-manifest-entries';
import {getSourceMapURL} from 'workbox-build/src/lib/get-source-map-url';
import {rebasePath} from 'workbox-build/src/lib/rebase-path';
import {replaceAndUpdateSourceMap} from 'workbox-build/src/lib/replace-and-update-source-map';
import {translateURLToSourcemapPaths} from 'workbox-build/src/lib/translate-url-to-sourcemap-paths';
import {validateInjectManifestOptions} from 'workbox-build/src/lib/validate-options';
