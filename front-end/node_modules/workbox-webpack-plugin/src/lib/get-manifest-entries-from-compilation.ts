...
import {getAssetHash} from 'workbox-webpack-plugin/src/lib/get-asset-hash';
import {resolveWebpackURL} from 'workbox-webpack-plugin/src/lib/resolve-webpack-url';
