...
import {getScriptFilesForChunks} from 'workbox-webpack-plugin/src/lib/get-script-files-for-chunks';
import {getManifestEntriesFromCompilation} from 'workbox-webpack-plugin/src/lib/get-manifest-entries-from-compilation';
import {relativeToOutputPath} from 'workbox-webpack-plugin/src/lib/relative-to-output-path';
